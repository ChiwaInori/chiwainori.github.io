...
/*
    ...
    JS Commands (17):
        Common (5): chance, Object.p.isolate, Array.p.add, Array.p.remove, String.p.getCountOf, Array.p.getCountOf
        Numeral (12):
    ...
    HTML Elements (10):
        ChiwaSet (7): ChiwaSet { (accessible attributes), hide, unhide, transColor, fadeOut, fadeIn, event }, cw
...
const urlParam = new function urlParam() {
    ...
    this.nonEnum("generate", (obj, clearExist = false) => {
        ...
        if (url.includes("[object")) { throw Object.assign(new TypeError("Cannot convert object value into URL"), { cwErr: "f-urlParamGenerate-object2URL" }); }
